    ...
    return Column(
      children: [
            ...
            child: SingleChildScrollView(
                ...
                child: Row(
                  ...
                  children: attendanceResponse?.groupData
                        ...
                        //     .groupColor[index % ColorConst.groupColor.length];
        ...
        Container(
          height: 300,
          child: SingleChildScrollView(
            scrollDirection: rotation == 0 ? Axis.horizontal : Axis.vertical,
            child: Container(
              width: rotation == 0
                  ? (attendacneData?.length ?? 10) *
                      ((attendacneData?.length ?? 1) < 5 ? 100 : 50)
                  : 300,
              height: rotation == 0
                  ? 300
                  : (attendacneData?.length ?? 10) *
              ...
              child: BarChart(
                transformationConfig: FlTransformationConfig(
                    maxScale: 1, scaleAxis: FlScaleAxis.vertical),
                BarChartData(
                  ...
                  titlesData: FlTitlesData(
                    bottomTitles: AxisTitles(
                      sideTitles: SideTitles(
                        showTitles: true,
                        reservedSize:
                            rotation == 0 ? 50 : 70, // Adjust based on rotation
                        interval: 1, // Show labels at intervals if too many
                      ...
                      sideTitles: SideTitles(
                          ...
                          getTitlesWidget: (value, meta) {
                            ...
                            return Padding(
                              ...
                              child: RotatedText(
                                rotationQuarterTurns: rotation,
                                text: attendacneData?[index].average ?? "",
                                style: TextStyle(
                  ...
                  borderData: FlBorderData(
                    show: true,
                    border: Border(
                      bottom: BorderSide(color: ColorConst.appHighLightColor),
                    ),
                  ),
